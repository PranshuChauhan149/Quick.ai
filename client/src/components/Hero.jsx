...
const Hero = () => {
  ...
  return (
    <div className="relative inline-flex flex-col w-full justify-center min-h-screen px-4 sm:px-20 xl:px-32 bg-[url('/gradientBackground.png')] bg-cover bg-no-repeat">
      <div className="text-center mb-6 ">
        <h1 className="text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl">
          Create amazing content <br /> with{" "}
          <span className="text-primary">AI tools</span>
        </h1>
        <p className="mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max:sm:text-xs text-gray-600y- ">
